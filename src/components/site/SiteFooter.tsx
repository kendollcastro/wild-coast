      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div>
          ...
          <nav className="mt-3 flex flex-col gap-2 text-sm" aria-label={dict.footer.explore}>
            <Link href="casas" className="text-ink/80 transition-colors hover:text-ink">
              {dict.footer.allCasas}
            </Link>
            <Link href="tours" className="text-ink/80 transition-colors hover:text-ink">
              {dict.footer.tours}
            </Link>
            <Link href="#como-funciona" className="text-ink/80 transition-colors hover:text-ink">
              {dict.footer.how}
            </Link>
            <Link href="casas" className="font-semibold text-coral-deep transition-colors hover:text-coral">
              {dict.footer.reserve}
            </Link>
          </nav>
        </div>
