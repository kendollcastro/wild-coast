-- 0008: fix de integridad en create_booking.
-- - Rechaza check_in en el pasado en reservas de propiedad (tour ya lo hacía).
-- - Agrega el error a los códigos conocidos para mensajes amigables.
-- Reemplaza la versión de 0003 agregando la validación en la rama property.
...
begin
  ...
  if p_booking_type = 'property' then
    ...
    if p_check_in < current_date then
      raise exception 'check_in_must_be_future';
    end if;
